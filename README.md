...
![LOGen Teaser Image](assets/teaser.png "Teaser")

LOGen is a Diffusion Transformer based method to generate novel views and rotations of objects as perceived by a LiDAR sensor.
...
We have a script for multi-gpu training, `gen_instance_pool.py`, which will check for existing files and generate according to the passed config. Alternatively a permutation file can be specified that and a specific number of instances can be generated.
...
![Comparison to generative baselines](assets/results.png "results")
