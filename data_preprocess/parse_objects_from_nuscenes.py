...
def parse_objects_from_nuscenes(dataroot, points_threshold, object_name, object_tag, range_to_use):
...
if __name__ == '__main__':
    dataroot = int(sys.argv[1])
    num_jobs = int(sys.argv[2])
    range_index = int(sys.argv[3])
    points_threshold = 5
    ...
    object_lidar_data, output_dir = parse_objects_from_nuscenes(dataroot, points_threshold, object_name, object_tag, curr_range)
